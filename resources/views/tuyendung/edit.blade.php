    ...
    <div class="m-grid__item m-grid__item--fluid  m-grid m-grid--ver	m-container m-container--responsive m-container--xxl m-page__container">
        <div class="m-grid__item m-grid__item--fluid m-wrapper">
            ...
            <div class="m-content">
                <div class="row">
                    <div class="col-lg-12">
                        {!! Form::model($model, ['method' => 'PATCH', 'url'=>'vitrituyendung/'. $model->id, 'class'=>'m-form m-form--fit m-form--label-align-right','id'=>'update_ttsp','files'=>true,'enctype'=>'multipart/form-data']) !!}
                                    ...
                                    <label>
                                        Mô tả công việc
                                                ...
                                                <textarea id="mota" class="form-control" name="mota" cols="30" rows="10"
                                                          placeholder="Mô tả công việc">{{$model->mota}}</textarea>
                                </div>
                            </div>
                            <div class="form-group m-form__group row">
                                <div class="col-lg-12">
                                    <label>
                                        Yêu cầu công việc
                                                ...
                                                <textarea id="yeucau" class="form-control" name="yeucau" cols="30" rows="10"
                                                          placeholder="Yêu cầu công việc">{{$model->yeucau}}</textarea>
                                </div>
                            </div>
                            <div class="form-group m-form__group row">
                                <div class="col-lg-12">
                                    <label>
                                        Quyền lợi được hưởng
                                                ...
                                                <textarea id="quyenloi" class="form-control" name="quyenloi" cols="30" rows="10"
                                                          placeholder="Quyền lợi được hưởng">{{$model->quyenloi}}</textarea>
                                </div>
                            </div>
